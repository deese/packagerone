...
2. Test it: `bash runner.sh -b <toolname> -f`
...
| nfpm | github | goreleaser/nfpm |
| packer | hashicorp | releases.hashicorp.com |
| ripgrep | github | BurntSushi/ripgrep |
| ssler | github | deese/ssler |
